...
class RecyclerMovieAdapter (val context: Context) : RecyclerView.Adapter<RecyclerMovieAdapter.MyViewHolder>() {

    var movieList : List<Movie> = listOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val view = LayoutInflater.from(parent.context).inflate(R.layout.recylcerview_list_item_adapter,parent,false)
